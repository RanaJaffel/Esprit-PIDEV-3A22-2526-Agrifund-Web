...
class AgriculteurDocumentController extends AbstractController
{
    ...
    #[Route('/add', name: 'agriculteur_documents_add')]
    public function add(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($file) {
                ...
                try {
                    ...
                    return $this->redirectToRoute('agriculteur_documents_index');
                } catch (\Exception $e) {
        ...
        return $this->render('agriculteur/documents/add.html.twig', [
            'form' => $form->createView(),
        ]);
    }

    #[Route('/{id}/edit', name: 'agriculteur_documents_edit')]
    public function edit(Document $document, Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('agriculteur/documents/edit.html.twig', [
            'form' => $form->createView(),
            'document' => $document,
        ]);
    }

    #[Route('/{id}/download', name: 'agriculteur_documents_download')]
    ...
    #[Route('/{id}/delete', name: 'agriculteur_documents_delete', methods: ['POST'])]
