 ...
 */
final class Version20260410221031 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE releve_hebdomadaire');
        ...
        $this->addSql('DROP INDEX idx_type ON capteur');
        $this->addSql('DROP INDEX fk_capteur_projet ON capteur');
        $this->addSql('DROP INDEX idx_statut ON capteur');
        $this->addSql('ALTER TABLE capteur MODIFY id_capteur INT NOT NULL');
        $this->addSql('ALTER TABLE capteur DROP typeCapteur, DROP modele, DROP localisation, DROP statut, DROP date_installation, DROP idproject, DROP id_user, CHANGE id_capteur id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('DROP INDEX fk_rapport_projet ON rapport_journalier');
        $this->addSql('ALTER TABLE rapport_journalier MODIFY id_rapport INT NOT NULL');
        $this->addSql('ALTER TABLE rapport_journalier DROP date_rapport, DROP type_mesure, DROP moyenne, DROP min, DROP max, DROP nb_mesures, DROP condition_dominante, DROP id_capteur, DROP idproject, CHANGE id_rapport id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE releve_terrain DROP FOREIGN KEY `releve_terrain_ibfk_1`');
        $this->addSql('DROP INDEX idx_capteur ON releve_terrain');
        $this->addSql('DROP INDEX idx_date ON releve_terrain');
        $this->addSql('DROP INDEX idx_type ON releve_terrain');
        $this->addSql('ALTER TABLE releve_terrain MODIFY id_releve INT NOT NULL');
        $this->addSql('ALTER TABLE releve_terrain DROP type_mesure, DROP valeur_mesuree, DROP unite, DROP date_heure, DROP id_capteur, DROP idproject, DROP source_donnee, CHANGE id_releve id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE releve_hebdomadaire (id_releve_hebdo INT AUTO_INCREMENT NOT NULL, idproject INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, temp_moyenne DOUBLE PRECISION DEFAULT \'0\', humidite_moyenne DOUBLE PRECISION DEFAULT \'0\', condition_dominante VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'\'\'NORMAL\'\'\' COLLATE `utf8mb4_general_ci`, nb_mesures_total INT DEFAULT 0, date_generation DATETIME DEFAULT \'current_timestamp()\' NOT NULL, INDEX idx_idproject (idproject), INDEX idx_date_debut (date_debut), PRIMARY KEY (id_releve_hebdo)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE capteur MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE capteur ADD typeCapteur VARCHAR(50) NOT NULL, ADD modele VARCHAR(100) DEFAULT \'\'\'Simulateur Python\'\'\', ADD localisation VARCHAR(100) NOT NULL, ADD statut VARCHAR(20) DEFAULT \'\'\'ACTIF\'\'\' NOT NULL, ADD date_installation DATETIME DEFAULT \'current_timestamp()\' NOT NULL, ADD idproject INT DEFAULT NULL, ADD id_user INT NOT NULL, CHANGE id id_capteur INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_capteur)');
        ...
        $this->addSql('CREATE INDEX idx_type ON capteur (typeCapteur)');
        $this->addSql('CREATE INDEX fk_capteur_projet ON capteur (idproject)');
        $this->addSql('CREATE INDEX idx_statut ON capteur (statut)');
        ...
        $this->addSql('ALTER TABLE rapport_journalier MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE rapport_journalier ADD date_rapport DATE NOT NULL, ADD type_mesure VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, ADD moyenne DOUBLE PRECISION NOT NULL, ADD min DOUBLE PRECISION NOT NULL, ADD max DOUBLE PRECISION NOT NULL, ADD nb_mesures INT DEFAULT 0, ADD condition_dominante VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'\'\'NORMAL\'\'\' COLLATE `utf8mb4_general_ci`, ADD id_capteur INT NOT NULL, ADD idproject INT DEFAULT NULL, CHANGE id id_rapport INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_rapport)');
        ...
        $this->addSql('CREATE INDEX fk_rapport_projet ON rapport_journalier (idproject)');
        $this->addSql('ALTER TABLE releve_terrain MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE releve_terrain ADD type_mesure VARCHAR(50) NOT NULL, ADD valeur_mesuree DOUBLE PRECISION NOT NULL, ADD unite VARCHAR(20) NOT NULL, ADD date_heure DATETIME DEFAULT \'current_timestamp()\' NOT NULL, ADD id_capteur INT NOT NULL, ADD idproject INT NOT NULL, ADD source_donnee VARCHAR(20) DEFAULT \'\'\'SIMULATEUR\'\'\', CHANGE id id_releve INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_releve)');
        ...
        $this->addSql('CREATE INDEX idx_capteur ON releve_terrain (id_capteur)');
        $this->addSql('CREATE INDEX idx_date ON releve_terrain (date_heure)');
        $this->addSql('CREATE INDEX idx_type ON releve_terrain (type_mesure)');
