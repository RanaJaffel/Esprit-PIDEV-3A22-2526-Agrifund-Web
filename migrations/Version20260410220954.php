 ...
 */
final class Version20260410220954 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rapport_journalier (id_rapport INT AUTO_INCREMENT NOT NULL, date_rapport DATE NOT NULL, type_mesure VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, moyenne DOUBLE PRECISION NOT NULL, min DOUBLE PRECISION NOT NULL, max DOUBLE PRECISION NOT NULL, nb_mesures INT DEFAULT 0, condition_dominante VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'\'\'NORMAL\'\'\' COLLATE `utf8mb4_general_ci`, id_capteur INT NOT NULL, idproject INT DEFAULT NULL, INDEX fk_rapport_projet (idproject), PRIMARY KEY (id_rapport)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
