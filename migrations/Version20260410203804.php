 ...
 */
final class Version20260410203804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agriculteur ADD type_culture VARCHAR(100) DEFAULT NULL, DROP typeCulture, CHANGE adresseferme adresseferme VARCHAR(255) DEFAULT NULL, CHANGE superficieferme superficieferme NUMERIC(10, 2) DEFAULT NULL, CHANGE statuscompte statuscompte VARCHAR(50) NOT NULL, CHANGE compteverifie compteverifie TINYINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agriculteur ADD typeCulture VARCHAR(100) DEFAULT \'NULL\', DROP type_culture, CHANGE adresseferme adresseferme VARCHAR(255) DEFAULT \'NULL\', CHANGE superficieferme superficieferme NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE statuscompte statuscompte VARCHAR(50) DEFAULT \'\'\'en_attente\'\'\', CHANGE compteverifie compteverifie TINYINT DEFAULT 0');
