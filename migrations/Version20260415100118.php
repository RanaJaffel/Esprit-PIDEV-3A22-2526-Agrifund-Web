 ...
 */
final class Version20260415100118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_code ON code2fa');
        $this->addSql('DROP INDEX idx_expiration ON code2fa');
        $this->addSql('ALTER TABLE code2fa CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE est_utilise est_utilise TINYINT NOT NULL, CHANGE date_utilisation date_utilisation DATETIME DEFAULT NULL, CHANGE type_envoi type_envoi VARCHAR(10) NOT NULL');
        $this->addSql('ALTER TABLE code2fa RENAME INDEX idx_utilisateur TO IDX_90274E24FB88E14F');
        ...
        $this->addSql('DROP INDEX idx_user_success ON face_recognition_log');
        $this->addSql('DROP INDEX idx_created_at ON face_recognition_log');
        $this->addSql('ALTER TABLE face_recognition_log CHANGE success success TINYINT NOT NULL, CHANGE confidence confidence DOUBLE PRECISION DEFAULT NULL, CHANGE ip_address ip_address VARCHAR(45) DEFAULT NULL, CHANGE user_agent user_agent VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE parametres2fa CHANGE est_active est_active TINYINT NOT NULL, CHANGE methode_preferee methode_preferee VARCHAR(20) NOT NULL, CHANGE telephone_2fa telephone_2fa VARCHAR(20) DEFAULT NULL, CHANGE date_activation date_activation DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE tel tel VARCHAR(20) DEFAULT NULL, CHANGE date_inscrit date_inscrit DATETIME NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL, CHANGE derniere_connexion derniere_connexion DATETIME NOT NULL, CHANGE est_en_ligne est_en_ligne TINYINT NOT NULL, CHANGE is_verified is_verified TINYINT NOT NULL, CHANGE face_descriptor face_descriptor LONGTEXT DEFAULT NULL, CHANGE face_enabled face_enabled TINYINT NOT NULL, CHANGE face_enrolled_at face_enrolled_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE utilisateur RENAME INDEX email TO UNIQ_1D1C63B3E7927C74');
        $this->addSql('ALTER TABLE verification_token CHANGE expires_at expires_at DATETIME NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE code2fa CHANGE date_creation date_creation DATETIME DEFAULT \'current_timestamp()\', CHANGE est_utilise est_utilise TINYINT DEFAULT 0, CHANGE date_utilisation date_utilisation DATETIME DEFAULT \'NULL\', CHANGE type_envoi type_envoi ENUM(\'email\', \'sms\') DEFAULT \'\'\'email\'\'\'');
        $this->addSql('CREATE INDEX idx_code ON code2fa (code)');
        $this->addSql('CREATE INDEX idx_expiration ON code2fa (date_expiration)');
        $this->addSql('ALTER TABLE code2fa RENAME INDEX idx_90274e24fb88e14f TO idx_utilisateur');
        ...
        $this->addSql('ALTER TABLE face_recognition_log CHANGE success success TINYINT DEFAULT 0 NOT NULL, CHANGE confidence confidence FLOAT DEFAULT \'NULL\', CHANGE ip_address ip_address VARCHAR(45) DEFAULT \'NULL\', CHANGE user_agent user_agent VARCHAR(255) DEFAULT \'NULL\', CHANGE created_at created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
        $this->addSql('CREATE INDEX idx_user_success ON face_recognition_log (utilisateur_id, success)');
        $this->addSql('CREATE INDEX idx_created_at ON face_recognition_log (created_at)');
        ...
        $this->addSql('ALTER TABLE parametres2fa CHANGE est_active est_active TINYINT DEFAULT 0, CHANGE methode_preferee methode_preferee ENUM(\'email\', \'sms\', \'desactive\') DEFAULT \'\'\'email\'\'\', CHANGE telephone_2fa telephone_2fa VARCHAR(20) DEFAULT \'NULL\', CHANGE date_activation date_activation DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE tel tel VARCHAR(20) DEFAULT \'NULL\', CHANGE date_inscrit date_inscrit DATETIME DEFAULT \'current_timestamp()\', CHANGE photo photo VARCHAR(255) DEFAULT \'NULL\', CHANGE derniere_connexion derniere_connexion DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE est_en_ligne est_en_ligne TINYINT DEFAULT 0, CHANGE is_verified is_verified TINYINT DEFAULT 0 NOT NULL, CHANGE face_descriptor face_descriptor LONGTEXT DEFAULT NULL COMMENT \'Descripteur facial encodé en JSON\', CHANGE face_enabled face_enabled TINYINT DEFAULT 0 COMMENT \'Reconnaissance faciale activée\', CHANGE face_enrolled_at face_enrolled_at DATETIME DEFAULT \'NULL\' COMMENT \'Date d\'\'enregistrement du visage\'');
        ...
        $this->addSql('ALTER TABLE verification_token CHANGE expires_at expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
