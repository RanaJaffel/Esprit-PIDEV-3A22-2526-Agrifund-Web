 ...
 */
final class Version20260411184507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE capteur CHANGE modele modele VARCHAR(100) NOT NULL, CHANGE statut statut VARCHAR(20) NOT NULL, CHANGE date_installation date_installation DATETIME NOT NULL, CHANGE idproject idproject INT NOT NULL');
        ...
        $this->addSql('DROP INDEX uniq_rj ON rapport_journalier');
        $this->addSql('DROP INDEX fk_rapport_projet ON rapport_journalier');
        $this->addSql('ALTER TABLE rapport_journalier CHANGE type_mesure type_mesure VARCHAR(50) NOT NULL, CHANGE nb_mesures nb_mesures INT NOT NULL, CHANGE condition_dominante condition_dominante VARCHAR(50) NOT NULL');
        $this->addSql('DROP INDEX idx_idproject ON releve_hebdomadaire');
        $this->addSql('DROP INDEX idx_date_debut ON releve_hebdomadaire');
        $this->addSql('ALTER TABLE releve_hebdomadaire CHANGE temp_moyenne temp_moyenne DOUBLE PRECISION DEFAULT NULL, CHANGE humidite_moyenne humidite_moyenne DOUBLE PRECISION DEFAULT NULL, CHANGE condition_dominante condition_dominante VARCHAR(50) DEFAULT NULL, CHANGE nb_mesures_total nb_mesures_total INT DEFAULT NULL, CHANGE date_generation date_generation DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE releve_terrain CHANGE date_heure date_heure DATETIME NOT NULL, CHANGE source_donnee source_donnee VARCHAR(20) NOT NULL, CHANGE qualite qualite VARCHAR(20) NOT NULL, CHANGE note note VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE capteur CHANGE modele modele VARCHAR(100) DEFAULT \'\'\'Simulateur Python\'\'\', CHANGE statut statut VARCHAR(20) DEFAULT \'\'\'ACTIF\'\'\' NOT NULL, CHANGE date_installation date_installation DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE idproject idproject INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE rapport_journalier CHANGE type_mesure type_mesure VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE nb_mesures nb_mesures INT DEFAULT 0, CHANGE condition_dominante condition_dominante VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'\'\'NORMAL\'\'\' COLLATE `utf8mb4_general_ci`');
        ...
        $this->addSql('CREATE UNIQUE INDEX uniq_rj ON rapport_journalier (idproject, id_capteur, type_mesure, date_rapport)');
        $this->addSql('CREATE INDEX fk_rapport_projet ON rapport_journalier (idproject)');
        $this->addSql('ALTER TABLE releve_hebdomadaire CHANGE temp_moyenne temp_moyenne DOUBLE PRECISION DEFAULT \'0\', CHANGE humidite_moyenne humidite_moyenne DOUBLE PRECISION DEFAULT \'0\', CHANGE condition_dominante condition_dominante VARCHAR(50) DEFAULT \'\'\'NORMAL\'\'\', CHANGE nb_mesures_total nb_mesures_total INT DEFAULT 0, CHANGE date_generation date_generation DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
        $this->addSql('CREATE INDEX idx_idproject ON releve_hebdomadaire (idproject)');
        $this->addSql('CREATE INDEX idx_date_debut ON releve_hebdomadaire (date_debut)');
        $this->addSql('ALTER TABLE releve_terrain CHANGE date_heure date_heure DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE source_donnee source_donnee VARCHAR(20) DEFAULT \'\'\'SIMULATEUR\'\'\', CHANGE qualite qualite VARCHAR(20) DEFAULT \'\'\'OK\'\'\' NOT NULL, CHANGE note note VARCHAR(255) DEFAULT \'NULL\'');
